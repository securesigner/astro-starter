      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={cn(
              "bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500",
        ...
        <div className="space-y-2 md:col-span-2">
          ...
          <textarea
            ...
            className={cn(
              ...
              "bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500",
          ...
          <div className="flex justify-between items-start gap-2">
            ...
            <span
              className={cn(
                ...
                !isError && !isWarning && "text-gray-400 dark:text-gray-500"
              )}
